...
- `src/lib/emoji.ts` — вырезание эмодзи из ответа модели (галочка «Без смайликов» в админке).
...
- `src/features/admin/RequestsTab.tsx` — журнал запросов: ход мысли Машинного интеллекта (с заменой реальных названий), ответ, файл, сработавшая тема.
